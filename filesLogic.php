...
//            $sql = "INSERT INTO fileup (name, size, downloads) VALUES ('$filename', $size, 0)";
...
//        $updateQuery = "UPDATE fileup SET downloads=$newCount WHERE id=$id";
